...
const ProfileHeader = () => {
    ...
    return (
        <>
            ...
            <div className=' mt-16 flex flex-col pr-6'>
                <h1 className=' text-2xl font-semibold'>{user.fullName}</h1>
                <p className=' w-2/3'>MERN Stack Developer || Focused on Building Reliable Web Applications || Interested in Software Engineering</p>
            </div>
        </>
    );
};
